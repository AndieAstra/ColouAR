...
@Component({
  selector: 'app-serviceberry-web',
  standalone: true,
  imports: [],
  templateUrl: './serviceberry-web.component.html',
  styleUrls: ['./serviceberry-web.component.scss']
})
export class ServiceberryWebComponent implements OnInit {
  ...
  private initThreeJS() {
    ...
    loader.load('assets/models/Berry.glb', (gltf: any) => {
      this.model = gltf.scene;
      this.model.position.y -= 7;  // Adjust this value to move the model down
